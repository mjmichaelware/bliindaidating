...
class AppConstants {
  ...
  // --- Gemini API Key ---
  // IMPORTANT: This key is now primarily managed by your Supabase Edge Function
  // via Supabase Secrets. Your Flutter app should NOT directly use a sensitive key here.
  // It's good to keep it empty on the client.
  ...
  static const Color primaryColorShade900 = Color(0xFF880E4F);
  static const Color primaryColorShade700 = Color(0xFFC2185B);
  static const Color primaryColorShade400 = Color(0xFFEC407A);

  static const Color secondaryColorShade900 = Color(0xFF0D47A1);
  static const Color secondaryColorShade700 = Color(0xFF1976D2);
  static const Color secondaryColorShade400 = Color(0xFF42A5F5);

  static const Color accentColor = secondaryColor;
  static const Color lightAccentColor = lightSecondaryColor;

  static const Color tertiaryColor = Color(0xFF8E24AA);
  static const Color lightTertiaryColor = Color(0xFFD1C4E9);

  static const Color complementaryColor1 = Color(0xFF00BCD4);
  static const Color complementaryColor2 = Color(0xFF4CAF50);
  static const Color complementaryColor3 = Color(0xFFFFC107);
  static const Color complementaryColor4 = Color(0xFF9C27B0);

  static const Color complementaryColor2Shade700 = Color(0xFF2E7D32);

  static const Color successColor = AppConstants.complementaryColor2;

  static const Color backgroundColor = Colors.black;
  static const Color surfaceColor = Color(0xFF1A1A1A);
  static const Color cardColor = Color(0xFF2C2C2C);
  static const Color dialogBackgroundColor = Color(0xFF2A2A2A);
  ...
  static const Color bannerBackgroundColorDark = Color(0xFF4A148C);
  static const Color bannerBackgroundColorLight = Color(0xFFD1C4E9);

  static const Color bannerTextColorDark = Colors.white;
  static const Color bannerTextColorLight = Colors.black87;

  static const Color bannerButtonColorDark = Color(0xFF0D47A1);
  static const Color bannerButtonColorLight = Color(0xFFBBDEFB);
